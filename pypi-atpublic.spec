...
Source0  : https://files.pythonhosted.org/packages/5d/18/b1d247792440378abeeb0853f9daa2a127284b68776af6815990be7fcdb0/atpublic-5.0.tar.gz
...
%prep
%setup -q -n atpublic-5.0
cd %{_builddir}/atpublic-5.0
pushd ..
cp -a atpublic-5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722006306
