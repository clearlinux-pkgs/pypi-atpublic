...
Source0  : https://files.pythonhosted.org/packages/ae/5b/61439625efcd11dfa2f299d60183476f58a138020c2f9b6a4e46b0e74d78/atpublic-4.1.0.tar.gz
...
%prep
%setup -q -n atpublic-4.1.0
cd %{_builddir}/atpublic-4.1.0
pushd ..
cp -a atpublic-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711839471
